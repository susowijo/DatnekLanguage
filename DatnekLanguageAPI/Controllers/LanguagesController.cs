...
using DatnekLanguageAPI.Models;

namespace DatnekLanguageAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class LanguagesController : ControllerBase
    {
        private readonly DatnekLanguageDBContext _context;

        public LanguagesController(DatnekLanguageDBContext context)
        {
            _context = context;
        }
